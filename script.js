...
const ITEM_DATABASE = {
    ...
    "Warden Set": [450, 'A', 'L'], "Scout Set": [450, 'A', 'L'], "Sorcerer Set": [450, 'A', 'L'], "Heavy Dragon Set": [1350, 'A', 'L'], "Medium Dragon Set": [1350, 'A', 'L'], "Light Dragon Set": [1350, 'A', 'L'], "Barbarian Set": [375, 'A', 'L'], "Medium Elven Set": [450, 'A', 'L'], "Heavy Elven Set": [450, 'A', 'L'], "Light Elven Set": [450, 'A', 'L'], "Heavy Betrayer Set": [525, 'A', 'L'], "Light Betrayer Set": [525, 'A', 'L'], "Medium Betrayer Set": [525, 'A', 'L'],
    "Valkyrie Helm": [375, 'P', 'L'], "Celestial Dragon Helm": [394, 'P', 'L'], "Medium Ymir Set": [600, 'A', 'L'], "Heavy Ymir Set": [600, 'A', 'L'], "Light Ymir Set": [600, 'A', 'L'],
    "Sand King Set": [1575, 'A', 'L'], "Light Tribal Set": [525, 'A', 'L'], "Witchdoctor Set": [563, 'A', 'L'], "Protector’s Helm": [375, 'P', 'L'], "Hellbound’s Helm": [375, 'P', 'L'], "Occultist’s Helm": [375, 'P', 'L'], "Huscarl’s Helmet": [375, 'P', 'L'], "Desert Mage’s Turban": [375, 'P', 'L'],
    ...
    "Berserk Potion": [1, 'F', 'N'], "Shield Potion": [1, 'F', 'N'], "Dragon Beer": [3, 'F', 'N'], "Dispel Potion": [25, 'F', 'N'], "Reflect Potion": [6, 'F', 'N'], "Clan Boss Potion": [10, 'F', 'N'], "Dexterity Potion": [50, 'F', 'N'], "Fury Potion": [50, 'F', 'N'], "Guardian’s Potion": [50, 'F', 'N'], "Invisibility Potion": [100, 'F', 'N'], "Purification Potion": [100, 'F', 'N'], "Elixir of Protector": [40, 'F', 'N'],
...
const itemCategories = {
    ...
    "2.3 Armor - Legendary": ["Warden Set", "Scout Set", "Sorcerer Set", "Heavy Dragon Set", "Medium Dragon Set", "Light Dragon Set", "Barbarian Set", "Medium Elven Set", "Heavy Elven Set", "Light Elven Set", "Heavy Betrayer Set", "Light Betrayer Set", "Medium Betrayer Set", "Medium Ymir Set", "Heavy Ymir Set", "Light Ymir Set", "Sand King Set", "Light Tribal Set", "Witchdoctor Set", "Valkyrie Helm", "Celestial Dragon Helm", "Protector’s Helm", "Hellbound’s Helm", "Occultist’s Helm", "Huscarl’s Helmet", "Desert Mage’s Turban"],
